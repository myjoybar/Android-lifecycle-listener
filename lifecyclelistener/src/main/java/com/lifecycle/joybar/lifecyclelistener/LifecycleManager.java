...
public class LifecycleManager {
    ...
    private LifecycleListenerFragment getSupportRequestManagerFragment(final android.app
            .FragmentManager fm) {
        LifecycleListenerFragment current = (LifecycleListenerFragment) fm.findFragmentByTag
                (getFragmentTag());
        if (current == null) {
    ...
    private SupportLifecycleListenerFragment getSupportRequestManagerFragment(android.support
                                                                                      .v4.app
                                                                                      .FragmentManager fm) {
        SupportLifecycleListenerFragment current = (SupportLifecycleListenerFragment) fm
